TEDxYale.Views.Footnotes ||= {}

class TEDxYale.Views.Footnotes.IndexView extends Backbone.View
  
  # Templates
  template: JST["backbone/templates/footnotes/index"]
  speakerTemplate: JST["backbone/templates/footnotes/speaker"]
  speakerModal: JST["backbone/templates/footnotes/speaker-modal"]
